                        ...
                        <div class="header__content">
                            ...
                            <div class="header__actions">
                                <form action="#" class="header__form">
                                    <input class="header__form-input" type="text" placeholder="Je recherche...">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
                        ...
                        <p class="footer__tagline">LAMOZIKA, site de diffusions et de partages à Madagascar</p>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0 offset-xl-1">
                        <h6 class="footer__title">Principale</h6>
                        <div class="footer__nav">
                            <a href="about.html">Accueil</a>
                            <a href="profile.html">Artistes</a>
                            <a href="pricing.html">Musiques</a>
                            <a href="contacts.html">Articles</a>
                            <a href="contacts.html">En direct</a>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
                        <h6 class="footer__title">Aides</h6>
                        <div class="footer__nav">
                            <a href="privacy.html">Compte & Facture</a>
                            <a href="privacy.html">Prix et plan tarifaire</a>
                            <a href="privacy.html">Materiele supporté</a>
                            <a href="privacy.html">Accessibilité</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="footer__content">
                            <div class="footer__links">
                                ...
                                <a href="privacy.html">Termes et conditions</a>
                            </div>
                            <small class="footer__copyright">© LAMOZIKA, 2021. Created by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Aristide VELONJATOVO</a>.</small>
                        </div>
                    </div>
                </div>
            </div>
