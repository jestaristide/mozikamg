    ...
    <div>
        ...
        <header class="header">
            <div class="header__content">
                <!-- header logo -->
                <inertia-link :href="route('admin.index')" class="header__logo">
        ...
        <div class="sidebar">
            <!-- sidebar logo -->
            <inertia-link :href="route('admin.index')" class="sidebar__logo">
            ...
            <ul class="sidebar__nav">
                <li class="sidebar__nav-item">
                    <inertia-link :href="route('admin.index')" class="sidebar__nav-link" :class="route().current('admin.index') ? 'sidebar__nav-link--active':''">
                ...
                <li class="sidebar__nav-item">
                    <inertia-link :href="route('admin.user.index')" class="sidebar__nav-link" :class="route().current('admin.user.index') ? 'sidebar__nav-link--active':''">
