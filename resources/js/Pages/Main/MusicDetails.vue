                ...
                <div class="row">
                    <div class="col-8 col-xl-8">
                        ...
                        <div class="article__content">
                            ...
                            <iframe :src="musique.yt_link" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                            <div class="article__actions article__actions--details pb-5">
                            ...
                            <p v-if="musique.content" v-for="content in musique.content.split('\n')">{{ content }}</p>
                        </div>
                        <!-- end article content -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h5 class="sidebar__title">Musiques similaires : </h5>
                            </div>
                            <div class="col-6 col-sm-4 col-lg-4 col-xl-3">
                                <div class="card">
                                    ...
                                    <h5 class="card__title"><a href="details.html">Selfie</a></h5>
