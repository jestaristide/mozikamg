    ...
    <site-layout>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-xl-6">
                        <h1 class="section__title section__title--head">Liste Musiques</h1>
                    </div>

                    <div class="col-12 col-xl-6">
                        <ul class="breadcrumb">
                            <li class="breadcrumb__item"><a :href="route('site.index')">Home</a></li>
                            <li class="breadcrumb__item breadcrumb__item--active">Liste Musiques</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row row--grid">
                <div v-for="musique in musiques" class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card">
                        <inertia-link :href="route('site.musique.show', {'slug':musique.slug})" class="card__cover">
                            <img :src="musique.jacket_link" alt="">
                        ...
                        <button class="card__add" type="button" :href="route('site.musique.show', {'slug':musique.slug})">
                        ...
                        <h3 class="card__title"><inertia-link :href="route('site.musique.show', {'slug':musique.slug})">{{ musique.title }}</inertia-link></h3>
                        <ul class="card__list">
                            <!--<li v-for="(art,index) in musique.artistes">{{index!==0 ? '-':'' + art.artist_name}}</li>-->
                            <li v-for="(art,index) in musique.artistes">{{index!==0 ? '&':''}} {{art.artist_name}}</li>
                        </ul>
                    </div>
                </div>
