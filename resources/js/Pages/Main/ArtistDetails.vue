<template>
    <site-layout>
        <section class="section section--head section--head-fixed section--gradient section--details-bg">
            <div class="section__bg" :data-bg="artiste.cover_link" :style="'background: url(' + artiste.cover_link + ') center top / cover no-repeat;'"></div>
            <div class="container">
                <!-- article -->
                <div class="article">
                    <div class="row">
                        <div class="col-12 col-xl-8">
                            ...
                            <div class="article__content">
                                <h1>{{ artiste.artist_name }}</h1>
                                <p v-for="desc in artiste.description.split('\n')">{{ desc }}</p>
                            </div>
                            <div class="share">
                            ...
                            <div class="row row--grid">
                                <div class="col-12">
                                    <h5 class="sidebar__title">SES MUSIQUES PUBLIES</h5>
                                </div>
                                ...
                                <div class="ccol-6 col-sm-4 col-lg-4 col-xl-3">
                                    <div class="card">
                                        <a href="details.html" class="card__cover">
                        ...
                        <div class="col-xl-4 col-12">
                            <form action="#" class="subscribe">
                                ...
                                <p class="subscribe__text">Souscrivez-vous pour recevoir tous nos nouveautés et actualités</p>
                                <div class="sign__group">
                                    <input type="text" class="sign__input" placeholder="Email">
                                </div>
                                <button type="button" class="sign__btn">Envoyer</button>
                            </form>

                            <div class="row">
                                <div class="col-6">
                                    <div class="row list_widget">
                                        <div class="col-4">
                                            <a href="details.html" class="card__cover">
                                                <img src="https://picsum.photos/640/650" alt="">
                                            </a>
                                        </div>
                                        <div class="col-8">
                                            <h5 class="card__title"><a href="details.html">The Dictator</a></h5>
                                            <ul class="card__list">
                                                <li>Free</li>
                                                <li>Comedy</li>
                                                <li>2012</li>
                            ...
                            <div class="row row--grid">
                                <div class="col-12">
                                    <h5 class="sidebar__title">Musiques ajoutés recemments</h5>
                                </div>
                                ...
                                <div class="col-12 card">
                                    <div class="row list_widget">
                                        <div class="col-4">
                                            <a href="details.html" class="card__cover">
                                                <img src="https://picsum.photos/640/640" alt="">
                                            </a>
                                        </div>
                                        <div class="col-8">
                                            <h5 class=""><a href="details.html">Selfie</a></h5>
                                            <p>Wendy Cathalina & Rebecca <br>26/03/2021</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 card">
...
<style>
.list_widget, .list_widget h5, .list_widget a {
    color: #fefefe;
}
</style>
